    ...
    <div class="col s12">
        <?php if (isset($latest_backup['timestamp']) && $latest_backup['timestamp'] < strtotime("-1 day")): ?>
            <div id="setting-error-" class="error settings-error notice is-dismissible">
                <p>
                    <strong>
                        <?php echo esc_html__('Your latest backup is older than 24 hours, please create a new backup to keep your site protected.', 'xcloner-backup-and-restore') ?>
                    </strong>
                </p>
        ...
        <?php if (!isset($latest_backup['timestamp'])): ?>
            <div id="setting-error-" class="error settings-error notice is-dismissible">
                <p>
                    <strong>
                        <?php echo esc_html__('You have no backup that I could find, please generate a new backup to keep your site protected.', 'xcloner-backup-and-restore') ?>
                    </strong>
                </p>
                <button type="button" class="notice-dismiss"><span
                            class="screen-reader-text">Dismiss this notice.</span>
        ...
        <?php if (!$requirements->check_backup_ready_status()): ?>
            <div id="setting-error-" class="error settings-error notice is-dismissible">
                <p>
                    <strong>
                        <?php echo esc_html__('Backup system not ready, please check and fix the issues marked in red', 'xcloner-backup-and-restore') ?>
                    </strong>
                </p>
                ...
                <li class="active">
                    ...
                    <div class="collapsible-body">
                        <div class="" id="backup-status">
                            <div class="">
                                <h5><?php echo esc_html__("Latest Backup", 'xcloner-backup-and-restore') ?></h5>
                                <blockquote>
                                    <?php if (isset($latest_backup)): ?>
                                        <div class="item">
                                            ...
                                            <?php echo esc_html($latest_backup['basename']) ?>
                                        </div>
                                        <div class="item">
                                            <div class="title">
                                                <?php echo esc_html__("Backup Size", 'xcloner-backup-and-restore') ?>:
                                            </div>
                                            <?php echo esc_html(size_format($latest_backup['size'])) ?>
                                        </div>
                                        <div class="item">
                                            <div class="title">
                                    ...
                                    <?php else: ?>
                                        <div class="item">
                                            <div class="title">
                                                <?php echo esc_html__("No Backup Yet", 'xcloner-backup-and-restore') ?></div>
                                        </div>
                                    <?php endif ?>
                                </blockquote>
                                <div>
                                    <h5><?php echo esc_html__("Backup Storage Usage", 'xcloner-backup-and-restore') ?></h5>
                                    <blockquote>
                                        <div class="item">
                                            <div class="title">
                                                <?php echo esc_html__("Total Size", 'xcloner-backup-and-restore') ?>
                                                :
                                            </div>
                                            <?php echo esc_html(size_format($xcloner_file_system->get_storage_usage())); ?>
                                        </div>
                                    </blockquote>
                                    <h5>
                                        <?php echo esc_html__("Next Scheduled Backup", 'xcloner-backup-and-restore') ?>
                                    </h5>
                                    <blockquote>
                                        <div class="item">
                                            <?php
                                            ...
                                            <?php if (isset($latest_schedule->name)): ?>
                                                <div class="title">
                                                    <?php echo esc_html__("Schedule Name", 'xcloner-backup-and-restore') ?>:
                                                </div>
                                                <?php echo esc_html($latest_schedule->name); ?>
                                            <?php endif; ?>
                                        </div>
                                        <div class="item">
                                            <div class="title">
                ...
                <?php if ($xcloner_settings->get_xcloner_option('xcloner_enable_log')) : ?>
                    <li class="active">
                        <div class="collapsible-header active">
                            ...
                            <?php echo esc_html__('XCloner Debugger', 'xcloner-backup-and-restore') ?>
                            <div class="right">
                                <a href="#<?php echo esc_attr($logger_basename = basename($logger->get_main_logger_url())) ?>"
                                   class="download-logger" title="<?php echo esc_attr($logger_basename) ?>">
                                    <span class="shorten_string">
                                        <?php echo esc_html($logger_basename) ?>&nbsp;&nbsp;&nbsp;
                                    </span>
                                </a>
                            </div>
                        </div>
                        <div class="collapsible-body">
                            <div class="console" id="xcloner-console"><?php if ($logger_content) {
                                    echo strip_tags(implode("<br />\n", array_reverse($logger_content)), "<br><a>"); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                                } ?>
                            </div>
                        </div>
                    </li>
        ...
        <div class="card blue-grey darken-1 z-depth-4 backup-ready">
            <div class="card-content white-text">
                <span class="card-title">
                    <?php echo esc_html__("System Check", 'xcloner-backup-and-restore') ?>
                </span>
                <ul>
                    <li class="card-panel <?php echo($requirements->check_xcloner_start_path(1) ? "teal" : "red") ?> lighten-2">
                        <?php echo esc_html__('Backup Start Location', 'xcloner-backup-and-restore') ?>:
                        <span class="shorten_string">
                            <?php echo esc_html($requirements->check_xcloner_start_path()); ?>
                        </span>
                    </li>
                    <li class="card-panel <?php echo($requirements->check_xcloner_store_path(1) ? "teal" : "red") ?> lighten-2">
                        <?php echo esc_html__('Backup Storage Location', 'xcloner-backup-and-restore') ?>:
                        <span class="shorten_string">
                            <?php echo esc_html($requirements->check_xcloner_store_path()); ?>
                        </span>
                    </li>
                    <li class="card-panel <?php echo($requirements->check_xcloner_tmp_path(1) ? "teal" : "red") ?> lighten-2">
                        <?php echo esc_html__('Temporary Location', 'xcloner-backup-and-restore') ?>:
                        <span class="shorten_string">
                            <?php echo esc_html($requirements->check_xcloner_tmp_path()); ?>
                        </span>
                    </li>
                    <li class="card-panel <?php echo($requirements->check_min_php_version(1) ? "teal" : "red") ?> lighten-2">
                        <?php echo esc_html__('PHP Version Check', 'xcloner-backup-and-restore') ?>
                        : <?php echo esc_html($requirements->check_min_php_version()); ?>
                        ( >= <?php echo esc_html($requirements::MIN_PHP_VERSION) ?>)
                    </li>
                    <li class="card-panel <?php echo($requirements->check_backup_ready_status() ? "teal" : "red") ?> lighten-2">
                        <?php echo($requirements->check_backup_ready_status() ? esc_html__('BACKUP READY', 'xcloner-backup-and-restore') : esc_html__('Backup not ready, please check above requirements', 'xcloner-backup-and-restore')) ?>
                        <i class="material-icons right tiny">
                            <?php echo($requirements->check_backup_ready_status() ? 'thumb_up' : 'thumb_down') ?>
                        </i>
                    </li>
                </ul>
                <ul class="additional_system_info">
                    <li class="card-panel grey darken-1">
                        <?php echo esc_html__('PHP max_execution_time', 'xcloner-backup-and-restore') ?>:
                        <?php echo esc_html($requirements->get_max_execution_time()); ?>
                    </li>
                    <li class="card-panel grey darken-1">
                        <?php echo esc_html__('PHP memory_limit', 'xcloner-backup-and-restore') ?>:
                        <?php echo esc_html($requirements->get_memory_limit()); ?>
                    </li>
                    <li class="card-panel grey darken-1">
                        <?php echo esc_html__('PHP open_basedir', 'xcloner-backup-and-restore') ?>:
                        <?php echo esc_html($requirements->get_open_basedir()); ?>
                    </li>
                    <?php
                    $data = array();
                    if ($requirements->check_backup_ready_status()) {
                    ...
                    <li class="card-panel grey darken-1">
                        ...
                        <?php echo esc_html($requirements->get_free_disk_space()); ?>
                    </li>
                </ul>
            </div>
            <div class="card-action">
                <a class="waves-effect waves-light btn system_info_toggle blue darken-1">
                    <i class="material-icons left">list</i>
                    <?php echo esc_html__('Toggle Additional System Info', 'xcloner-backup-and-restore') ?>
                </a>
            </div>
        </div>
