...
<script>
    var storage_selection = '<?php echo esc_js($storage_selection)?>';
</script>
...
<div class="row">
    ...
    <div class="input-field  col s12 l4 left remote-storage-selection">
        <select name="storage_selection" id="storage_selection" class="validate" required>
            ...
            <option value="" selected>
                <?php echo esc_html__('Change To Local Storage...', 'xcloner-backup-and-restore') ?>
            </option>
            <?php else: ?>
            <option value="" selected>
                <?php echo esc_html__('Change To Remote Storage...', 'xcloner-backup-and-restore') ?>
            </option>
            <?php endif; ?>
    ...
    <div class="col s12">
        <table id="manage_backups" style="width:100%">
            <thead>
                <tr class="grey lighten-2">
                    ...
                    <th data-field="id"><?php echo esc_html__("Backup Name", 'xcloner-backup-and-restore') ?></th>
                    <th data-field="name"><?php echo esc_html__("Created Time", 'xcloner-backup-and-restore') ?></th>
                    <th data-field="name"><?php echo esc_html__("Size", 'xcloner-backup-and-restore') ?></th>
                    <th class="no-sort" data-field="price"><?php echo esc_html__("Action", 'xcloner-backup-and-restore') ?></th>
        ...
        <a class="waves-effect waves-light btn delete-all">
            ...
            <?php echo esc_html__("Delete", 'xcloner-backup-and-restore') ?>
        </a>
    </div>
    ...
    <div id="backup_encryption_modal" class="modal">
        <div class="modal-content">
            <h4><?php echo sprintf(__("Backup Content Encryption", 'xcloner-backup-and-restore'), "") // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></h4>
            <h5 class="backup-name"></h5>
            ...
            <div class="notice">
                <p>
                    <?php echo esc_html__("This option will encrypt your backup archive with your current XCloner Encryption Key.", 'xcloner-backup-and-restore') ?>
                </p>
                <p class="center-align">
                    <a
                        class="waves-effect waves-light btn"><?php echo esc_html__("START ENCRYPTION", 'xcloner-backup-and-restore') ?></a>
                </p>
            </div>
            <ul class="files-list">
            </ul>
    ...
    <div id="backup_decryption_modal" class="modal">
        <div class="modal-content">
            <h4><?php echo sprintf(__("Backup Content Decryption", 'xcloner-backup-and-restore'), "") // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></h4>
            <h5 class="backup-name"></h5>
            ...
            <div class="notice">
                ...
                <p class="center-align">
                    <a
                        class="waves-effect waves-light btn"><?php echo esc_html__("START DECRYPTION", 'xcloner-backup-and-restore') ?></a>
                </p>
            </div>
            <ul class="files-list">
    ...
    <div id="local_storage_upload_modal" class="modal">
        <div class="modal-content">
            <h4>
                <?php echo sprintf(__("Transfer Remote Backup To Local Storage", 'xcloner-backup-and-restore'), "") // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
            </h4>
            <h5 class="backup-name"></h5>
            ...
            <div class="row status">
                ...
                <?php echo esc_html__("Uploading backup to the local storage filesystem...", 'xcloner-backup-and-restore') ?>
    ...
    <div id="remote_storage_modal" class="modal">
        <form method="POST" class="remote-storage-form">
            ...
            <div class="modal-content">
                <h4><?php echo esc_html__("Remote Storage Transfer", 'xcloner-backup-and-restore') ?></h4>
                <p>
                    <?php if (sizeof($available_storages)): ?>
                    <div class="row">
