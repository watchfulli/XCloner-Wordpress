        ...
        <ul class="collapsible xcloner-restore collapsible-accordion" data-collapsible="accordion">
            <li data-step="1" class="restore-script-upload-step steps">
                <div class="collapsible-header active">
                    ...
                    <?php echo esc_html__("Restore Script Upload", 'xcloner-backup-and-restore') ?>
                </div>
                <div class="collapsible-body row">
                    ...
                    <div class="col s12">
                        <ul class="text-steps">
                            <li>
                                <?php echo esc_html__("Please ", 'xcloner-backup-and-restore') ?>
                                <a href="https://www.xcloner.com/downloads/"
                                   class="btn waves-effect waves-light"
                                   target="_blank"
                                >
                                    <?php echo esc_html__("download the restore script", 'xcloner-backup-and-restore') ?>
                                </a>
                            </li>
                            <li>
                                <?php echo esc_html__("Extract the restore script archive files on your new host", 'xcloner-backup-and-restore') ?>
                            </li>
                            <li>
                                <?php echo __("Provide url below to the <u>xcloner_restore.php</u> restore script, like http://my_restore_site.com/xcloner_restore.php", 'xcloner-backup-and-restore') // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
                            </li>
                            <li>
                                <?php echo esc_html__("If your server is not web accessible, like a localhost computer, you can use a DynDNS service or install a blank copy of Wordpress with XCloner in the same environment and start the restore from there.", 'xcloner-backup-and-restore') ?>
                            </li>
                            <?php if (is_ssl()): ?>
                                <li class="warning">
                    ...
                    <div class="col l3 s12 right-align">
                        <button class="btn waves-effect waves-light" type="submit" id="validate_url"
                                ...
                                <?php echo esc_html__("Check Connection", 'xcloner-backup-and-restore') ?>
            ...
            <li data-step="2" class="backup-upload-step steps">
                <div class="collapsible-header ">
                    ...
                    <?php echo esc_html__("Upload Local Backup Archive To Target Host", 'xcloner-backup-and-restore') ?>
                </div>
                <div class="collapsible-body row">
                    <div class="input-field col s12 l7">
                        <p>
                            <?php echo esc_html__("You can skip this step if you want to transfer the archive in some other way, make sure you upload it in the same directory as the restore script from the previous step.", 'xcloner-backup-and-restore') ?>
                        </p>
                        <select id="backup_file" name="backup_file" class="browser-default">
                            <option value="" disabled selected>
                                <?php echo esc_html__("Please select a local backup archive to upload to target host", 'xcloner-backup-and-restore') ?>
                            </option>
                            <?php if (is_array($backup_list)): ?>
                                <?php foreach ($backup_list as $file): ?>
                                    <option value="<?php echo $file['basename'] // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>">
                                        <?php echo $file['basename'] // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?> (<?php echo $file['size'] // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>)
                                    </option>
                                <?php endforeach ?>
                            <?php endif ?>
                        </select>
                    ...
                    <div class="col s12 l5 right-align">
                        <div class="toggler">
                            <button class="btn waves-effect waves-light upload-backup normal" type="button" id=""
                                    name="action"><?php echo esc_html__("Upload", 'xcloner-backup-and-restore') ?>
                                <i class="material-icons left">upload</i>
                            </button>
                            <button class="btn waves-effect waves-light red upload-backup cancel" type="button" id=""
                                    name="action"><?php echo esc_html__("Cancel", 'xcloner-backup-and-restore') ?>
                                <i class="material-icons right">close</i>
                            </button>
                        </div>
                        <button class="btn waves-effect waves-light grey" type="button"
                                title="<?php echo esc_html__("Next", 'xcloner-backup-and-restore') ?>" id="skip_upload_backup"
                                name="action"><?php echo esc_html__("Next", 'xcloner-backup-and-restore') ?>
                ...
                <div class="collapsible-header">
                    <div class="row" style="margin-bottom: 0">
                        <div class="col">
                            ...
                            <?php echo esc_html__("Restore Files Backup Available On Target Location", 'xcloner-backup-and-restore') ?>
                        </div>

                        <div class="switch right col">
                            <label>
                                <?php echo esc_html__('Verbose Output', 'xcloner-backup-and-restore') ?>
                            ...
                            <div class="input-field row">
                                <div class="col s12">
                                    <a class="btn-floating tooltipped btn-small right" data-html="true" data-position="left"
                                       data-delay="50" data-tooltip="<?php echo esc_html__("This is the directory where you would like to restore the backup archive files.<br /> 
										Please use this with caution when restoring to a live site.", 'xcloner-backup-and-restore') ?>">
                                        <i class="material-icons">help_outline</i>
                                    </a>
                                    <h5><?php echo esc_html__("Restore Target Path:", 'xcloner-backup-and-restore') ?></h5>
                            ...
                            <div class="input-field row">
                                <div class="col s12">
                                    <a href="#"
                                       ...
                                       data-tooltip="<?php echo esc_html__('Click To List The Selected Backup Content', 'xcloner-backup-and-restore') ?>">
                                        <i class="material-icons">folder_open</i>
                                    </a>
                                    <h5><?php echo esc_html__("Restore Backup Archive:", 'xcloner-backup-and-restore') ?></h5>
                                    <div class="row">
                                        <div class="col s11">
                                            <select id="remote_backup_file" name="remote_backup_file" class="browser-default">
                                                <option value="" disabled selected>
                                                    <?php echo esc_html__("Please select a remote backup archive to restore", 'xcloner-backup-and-restore') ?>
                                                </option>
                                            </select>
                                        </div>
                                        <div class="col s1">
                                ...
                                <div class="col s12">
                                    ...
                                    <label for="filter_files_all" class="tooltipped" data-position="right"
                                           data-tooltip="<?php echo esc_html__("Restore all backup files", 'xcloner-backup-and-restore') ?>">
                                        <input class="with-gap" name="filter_files" type="radio" id="filter_files_all" checked value=""/>
                                        <span>
                                        <?php echo esc_html__("Restore All Files", "xcloner-backup-and-restore") ?>
                                    </span>
                                    </label>


                                    <label for="filter_files_wp_content" class="tooltipped"
                                           data-tooltip="<?php echo esc_html__('Restore the files only of the wp-content/ folder', 'xcloner-backup-and-restore') ?>">
                                        <input class="with-gap" name="filter_files" type="radio"
                                               id="filter_files_wp_content" value="/^wp-content\/(.*)/"/>
                                        <span>
                                        <?php echo esc_html__("Only wp-content", "xcloner-backup-and-restore") ?>
                                    </span>
                                    </label>


                                    <label for="filter_files_plugins" class="tooltipped"
                                           data-tooltip="<?php echo esc_html__('Restore the files only of the wp-content/plugins/ folder', 'xcloner-backup-and-restore') ?>">
                                        <input class="with-gap" name="filter_files" type="radio" id="filter_files_plugins"
                                               value="/^wp-content\/plugins(.*)/"/>
                                        <span>
                                        <?php echo esc_html__("Only Plugins", "xcloner-backup-and-restore") ?>
                                    </span>
                                    </label>


                                    <label for="filter_files_uploads" class="tooltipped"
                                           data-tooltip="<?php echo esc_html__('Restore the files only of the wp-content/uploads/ folder only', 'xcloner-backup-and-restore') ?>">
                                        <input class="with-gap" name="filter_files" type="radio" id="filter_files_uploads"
                                               value="/^wp-content\/uploads(.*)/"/>
                                        <span>
                                        <?php echo esc_html__("Only Uploads", "xcloner-backup-and-restore") ?>
                                    </span>
                                    </label>


                                    <label for="filter_files_themes" class="tooltipped"
                                           data-tooltip="<?php echo esc_html__('Restore the files only of the wp-content/themes/ folder', 'xcloner-backup-and-restore') ?>">
                                        <input class="with-gap" name="filter_files" type="radio" id="filter_files_themes"
                                               value="/^wp-content\/themes(.*)/"/>
                                        <span>
                                        <?php echo esc_html__("Only Themes", "xcloner-backup-and-restore") ?>
                                    </span>
                                    </label>


                                    <label for="filter_files_database" class="tooltipped"
                                           data-tooltip="<?php echo esc_html__('Restore the database-sql.sql mysql backup from the xcloner-xxxxx/ folder', 'xcloner-backup-and-restore') ?>">
                                        <input class="with-gap" name="filter_files" type="radio" id="filter_files_database"
                                               value="#^xcloner-(.*)/(.*).sql#"/>
                                        <span>
                                        <?php echo esc_html__("Only Database Backup", "xcloner-backup-and-restore") ?>
                                    </span>
                                    </label>
                                </div>
                            </div>
                    ...
                    <div class="col s12 l5 right-align">
                        <div class="toggler">
                            <button class="btn waves-effect waves-light normal" form="restore_backup_to_path_form" id="restore_backup_to_path_submit" type="submit">
                                <?php echo esc_html__("Restore", 'xcloner-backup-and-restore') ?>
                                <i class="material-icons left">download</i>
                            </button>
                            <button class="btn waves-effect waves-light red cancel" type="button"
                                    id="restore_backup_to_path_cancel" name="action"><?php echo esc_html__("Cancel", 'xcloner-backup-and-restore') ?>
                                <i class="material-icons right">close</i>
                            </button>
                        </div>
                        <button class="btn waves-effect waves-light grey" type="button"
                                title="<?php echo esc_html__("Next", 'xcloner-backup-and-restore') ?>"
            ...
            <li data-step="4" class="restore-remote-database-step steps">
                <div class="collapsible-header">
                    <i class="material-icons">list</i><?php echo esc_html__("Restore Database", 'xcloner-backup-and-restore') ?>
                ...
                <div class="collapsible-body row">
                    ...
                    <div id="remote-restore-options">
                        <div class="col s12">
                            <a class="btn-floating tooltipped btn-small right" data-position="left" data-delay="50"
                                data-html="true"
                                data-tooltip="<?php echo __('Please provide below the mysql connection details for the target host database.<br />For live sites we recommend using a new separate database.', 'xcloner-backup-and-restore') // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>"
                                data-tooltip-id="92c95730-94e9-7b59-bd52-14adc30d5e3e"><i
                                    class="material-icons">help_outline</i></a>
                            <h5><?php echo esc_html__('Target Mysql Details', 'xcloner-backup-and-restore') ?></h5>
                        </div>
                        <div class=" col s12">
                            <div class="input-field col s12 m6">
                                <input type="text" name="remote_mysql_host" id="remote_mysql_host" class="validate"
                                    placeholder="Target Mysql Hostname">
                                <label><?php echo esc_html__("Target Mysql Hostname", 'xcloner-backup-and-restore') ?></label>
                            </div>

                            <div class="input-field  col s12 m6">
                                <input type="text" name="remote_mysql_db" id="remote_mysql_db" class="validate"
                                    placeholder="Target Mysql Database">
                                <label><?php echo esc_html__("Target Mysql Database", 'xcloner-backup-and-restore') ?></label>
                            </div>

                            <div class="input-field  col s12 m6">
                                <input type="text" name="remote_mysql_user" id="remote_mysql_user" class="validate"
                                    placeholder="Target Mysql Username">
                                <label><?php echo esc_html__("Target Mysql Username", 'xcloner-backup-and-restore') ?></label>
                            </div>
                            ...
                            <div class="input-field  col s12 m6">
                                ...
                                <label><?php echo esc_html__("Target Mysql Password", 'xcloner-backup-and-restore') ?></label>
                            </div>
                    ...
                    <div class=" col s12 l7">
                        <div class="input-field row">
                            <div class="col s12">
                                <select id="remote_database_file" name="remote_database_file" class="browser-default">
                                    <option value="" disabled selected>
                                        <?php echo esc_html__("Please select the target database backup file to restore", 'xcloner-backup-and-restore') ?>
                                    </option>
                                </select>
                        ...
                        <div class="status"></div>
                        <div class="query-box">
                            <h6><?php echo esc_html__('Use the field below to fix your mysql query and Retry again the Restore, or replace with # to Skip next', 'xcloner-backup-and-restore') ?>
                            </h6>
                    ...
                    <div class="col s12 l5 right-align">
                        <div class="toggler">
                            <button class="btn waves-effect waves-light restore_remote_mysqldump normal " type="submit"
                                    id="" name="action"><?php echo esc_html__("Restore", 'xcloner-backup-and-restore') ?>
                                <i class="material-icons left">download</i>
                            </button>
            ...
            <li data-step="5" class="restore-finish-step steps ">
                <div class="collapsible-header"><i
                            class="material-icons">folder_open</i><?php echo esc_html__("Finishing up...", 'xcloner-backup-and-restore') ?>
                </div>
                <div class="collapsible-body" style="padding-left:40px;">

                    <div class="row">
                        <div class="col s4">
                            <span><?php echo esc_html__("Update wp-config.php mysql details and update the Target Site Url", 'xcloner-backup-and-restore') ?></span>
                        </div>
                    ...
                    <div class="row">
                        <div class="col s4">
                            <span><?php echo esc_html__("Delete Restored Backup Temporary Folder", 'xcloner-backup-and-restore') ?></span>
                        </div>
                        <div class="col s8">
                            <div class="switch">
                                <label>
                    ...
                    <div class="row">
                        <div class="col s4">
                            <span><?php echo esc_html__("Delete Backup Archive", 'xcloner-backup-and-restore') ?></span>
                        </div>
                        <div class="col s8">
                            <div class="switch">
                                <label>
                    ...
                    <div class="row">
                        <div class="col s4">
                            <span><?php echo esc_html__("Delete Restore Script", 'xcloner-backup-and-restore') ?></span>
                        </div>
                        <div class="col s8">
                            <div class="switch">
                                <label>
                    ...
                    <div class="row">
                        <div class="col s12 center-align">
                            <button class="btn waves-effect waves-light teal" type="submit" id="restore_finish"
                                    name="action"><?php echo esc_html__("Finish", 'xcloner-backup-and-restore') ?>
                                <i class="material-icons right">navigate_next</i>
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col s12 center-align" id="xcloner_restore_finish">
                            <h5><?php echo esc_html__("Thank you for using XCloner.", 'xcloner-backup-and-restore') ?></h5>
                            <div class="row">
                                <div class="col s6 right-align">
                                    <a href="https://wordpress.org/support/plugin/xcloner-backup-and-restore/reviews/#new-post" class="btn waves-effect waves-light teal" type="button" target="_blank">
                                        <?php echo esc_html__("Leave a review", 'xcloner-backup-and-restore') ?>
                                        <i class="material-icons right">navigate_next</i>
                                    </a>
                                </div>
                                <div class="col s6 left-align">
                                    <a href="https://wordpress.org/support/plugin/xcloner-backup-and-restore/%60" class="btn waves-effect waves-light teal" type="button" target="_blank">
                                        <?php echo esc_html__("Get support", 'xcloner-backup-and-restore') ?>
                                        <i class="material-icons right">navigate_next</i>
                                    </a>
                                </div>
                            </div>
...
<div id="backup_cotent_modal" class="modal">
    <div class="modal-content">
        <h4><?php echo sprintf(__("Listing Backup Content ", 'xcloner-backup-and-restore'), "") // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></h4>
